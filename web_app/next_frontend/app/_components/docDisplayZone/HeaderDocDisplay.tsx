...
function HeaderDocDisplay({fileToDisplay, docViewerWidth, numPages, setZoomLevel, currentPage, setDisplayFileExplorer, displayFileExplorer }) {
  ...
  return (
    ...
    <div>
      <GiHamburgerMenu className='hover:text-red-600' onClick={() => {setDisplayFileExplorer(!displayFileExplorer)}}/>
